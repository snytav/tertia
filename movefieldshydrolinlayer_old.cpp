...
//         rp = dens;
         ...
         fft_of_Rho[n1] = rp - (fft_of_JxP[n1] - fft_of_Jx[n1]) - aky*hx*fft_of_Jy[n1] - akz*hx*fft_of_Jz[n1];
...
//         fft_of_By[n1] = (-akz*(fft_of_Jx[n1] + fft_of_JxBeam[n1]) - diff_jz  + dens*fft_of_By[n1])/(ak2+dens);
//         fft_of_Bz[n1] =  (aky*(fft_of_Jx[n1] + fft_of_JxBeam[n1]) + diff_jy + dens*fft_of_Bz[n1])/(ak2+dens);

         //         vcRho[n1] = rp + h*dens*vcEx[n1] - aky*h*I*vcJy[n1] - akz*h*I*vcJz[n1];
         fft_of_Rho[n1] = rp - (fft_of_JxP[n1] - fft_of_Jx[n1]) - aky*h*fft_of_Jy[n1] - akz*h*fft_of_Jz[n1];
