...
/*
         vcEx[n1] = vcExp[n1]*phi_p + hx*phi1*(vcEx[n1]);
         vcEy[n1] = vcEyp[n1]*phi_p + hx*phi1*(vcEy[n1]);
         vcEz[n1] = vcEzp[n1]*phi_p + hx*phi1*(vcEz[n1]);
         vcBx[n1] = vcBxp[n1]*phi_p + hx*phi1*(vcBx[n1]);
         vcBy[n1] = vcByp[n1]*phi_p + hx*phi1*(vcBy[n1]);
         vcBz[n1] = vcBzp[n1]*phi_p + hx*phi1*(vcBz[n1]);
         */
       }
   }
   ...
   for (int n=0; n<ncomplex; n++) {
      ...
      vcEx[n1] = vcRho[n1];
//      vcEx[n1] = vcExp[n1]*phi_p + vcRho[n1];
