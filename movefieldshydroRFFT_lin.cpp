...
//   I.im = 1.;
   ...
   for (int i=0; i<ncomplex; i++) {
      ...
      = fft_of_JxP[i] = fft_of_JyP[i] = fft_of_JzP[i]
...
/*            
            fft_of_By[n1] =   dens*fft_of_Ez[n1]/ak2 - akz*(fft_of_Jx[n1] + fft_of_JxBeam[n1])/ak2;
            fft_of_Bz[n1] =  -dens*fft_of_Ey[n1]/ak2 + aky*(fft_of_Jx[n1] + fft_of_JxBeam[n1])/ak2;
*/            
            fft_of_By[n1] =  (-dens*fft_of_Ez[n1] + akz*(-dens/(dens+ak2)*rp + fft_of_JxBeam[n1]))/ak2;
            fft_of_Bz[n1] = -(-dens*fft_of_Ey[n1] + aky*(-dens/(dens+ak2)*rp + fft_of_JxBeam[n1]))/ak2;
