...
int CUDA_WRAP_writeXYSection(int Nx,int Ny,int Nz,double hx,double hy,double *d_3d,char *name,int step)
{
    double *h_ex;
    char fname[100];
    FILE *f;
...
int CUDA_WRAP_diagnose(int l_Xsize,int l_Ysize,int l_Zsize,double hx, double hy,int step)
{
  CUDA_WRAP_writeXYSection(l_Xsize,l_Ysize,l_Zsize,hx,hy,d_Ex3D,"EX",step);
  CUDA_WRAP_writeXYSection(l_Xsize,l_Ysize,l_Zsize,hx,hy,d_Ey3D,"EY",step);
  CUDA_WRAP_writeXYSection(l_Xsize,l_Ysize,l_Zsize,hx,hy,d_Ez3D,"EZ",step);
  
  CUDA_WRAP_writeXYSection(l_Xsize,l_Ysize,l_Zsize,hx,hy,d_RhoBeam3D,"RhoBeam",step);
